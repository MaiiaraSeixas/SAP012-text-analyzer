...
// Está atualizando a pagina de acordo com os elementos do site e mostrando os resultados das análises que contem no analayzer
        ...
        contagemNumeros.textContent = 'Contagem de Números: ' + analyzer.getNumbersCount(texto);
        somaNumeros.textContent = 'Soma Total dos Números: ' + analyzer.getNumbersSum(texto);
